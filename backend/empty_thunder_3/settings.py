"""
Django settings for empty_thunder_3 project.
...
ROOT_URLCONF = 'empty_thunder_3.urls'
...
WSGI_APPLICATION = 'empty_thunder_3.wsgi.application'
...
DEFAULT_FROM_EMAIL = env.str(
    "DEFAULT_FROM_EMAIL", "Empty Thunder Support <support@empty-thunder-3.botics.io>"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "empty_thunder_3 API",
    "DESCRIPTION": "API documentation for empty_thunder_3 App",
    "VERSION": "v1",
}
